...
grep -Fq '| Architect | `sol` | `high` | `codex` | `anthropic` | `anthropic-opus-4-8` |' "$PROJECT/.agents/models.md"
grep -Fq '| Designer | `sol` | `high` | `codex` | `anthropic` | `anthropic-opus-4-8` |' "$PROJECT/.agents/models.md"
