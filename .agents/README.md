...
- Concurrent implementation tickets use dedicated branches and worktrees when available. Otherwise serialize mutating/building tickets. Reviewer and Tester verify the ticket's recorded SHA in a clean verification worktree; merge ticket commits into an integration branch for one full matrix before main.
