...
- Verify the exact commit SHA reviewed by Reviewer in a clean verification worktree. If it changed, require the relevant review/test gates again and record the ticket-scoped artifact root.
